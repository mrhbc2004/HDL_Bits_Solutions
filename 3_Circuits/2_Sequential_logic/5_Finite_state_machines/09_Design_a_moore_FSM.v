module top_module (
    ...
    localparam [2:0] A = 3'd0, //water level below S1
    				 B0 = 3'd1, //water level between S1 and S2 previous level was higher
    				 B1 = 3'd2, //s1~s2, previous level lower
    				 C0 = 3'd3, //s2~s3, previous level higher
    				 C1 = 3'd4, // s2~s3, previous level lower
    				 D = 3'd5; // above s3
